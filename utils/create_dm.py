...
def export_file(cache_filename, local_filename):
    url = r'https://portal.nersc.gov/project/cmb/pysm-data/'+cache_filename    
    if(not is_url(url)):
...
import_file(local_dir + "dust_beta_2deg.fits", "pysm_2/dust_beta_2deg.fits")
import_file(local_dir + "dust_temp_2deg.fits", "pysm_2/dust_temp_2deg.fits")
